  ...
  return (
    <>
          ...
          <div className="mb-3 text-center fs-5">
            ...
            <span
              className={`fs-4 fw-bold ${
                paperBalance > 0 ? "text-success" : "text-danger"
              }`}
            >
              {paperBalance}
            </span>{" "}
      ...
      <Modal show={showModal} onHide={handleClose}>
        ...
        <Modal.Body>
          <p>
            <strong>Số trang mua:</strong> {receipt.pages} trang
          </p>
          <p>
            <strong>Tổng giá:</strong> {receipt.totalPrice.toLocaleString()} VND
          </p>
          <p>
            <strong>Phương thức thanh toán:</strong> BKPay
          </p>
          <p>
            <strong>Ngày giao dịch:</strong> {receipt.date}
          </p>
        </Modal.Body>
        <Modal.Footer>
